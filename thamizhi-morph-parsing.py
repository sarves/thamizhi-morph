...
morph_tagged_file="morph-tagged"
...
pos_morph_aligned.write("#This POS-Morphology tagged file was annotated using ThamizhiMorph morphological analyser (Python version) \n \
#This is formatted in CoNLL-U format \n \
#More information about ThamizhiMorph can be found here: http://nlp-tools.uom.lk/thamizhi-morph/ \n \
...
#Tagged on "+ str(datetime.datetime.now()) +" \n")
morph_tagged.write("#This POS-Morphology tagged file was annotated using ThamizhiMorph morphological analyser (Python version) \n \
#More information about ThamizhiMorph can be found here: http://nlp-tools.uom.lk/thamizhi-morph/ \n \
#Tagged on "+ str(datetime.datetime.now()) +" \n")
